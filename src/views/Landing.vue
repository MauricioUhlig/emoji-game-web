      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img :src="imagem" class="img-fluid floating" />
          </div>
        ...
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <div class="card bg-default shadow border-0">
              <img
                v-lazy="'@public/img/theme/img-1-1200x1000.jpg'"
                class="card-img-top"
              />
...
<script lang="ts">
import promo_1 from "../../public/@public/img/theme/promo-1.png";
export default {
  name: "home",
  components: {},
  data() {
